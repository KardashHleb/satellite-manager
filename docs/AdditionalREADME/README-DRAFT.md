...
События создания/удаления спутника (Kafka): [docs/KAFKA_SATELLITE_EVENTS.md](../KAFKA_SATELLITE_EVENTS.md).
...
Вопрос из задания про **@Embedded** и **@OneToOne** — в [docs/JPA_EMBEDDED_VS_ONETOONE.md](../JPA_EMBEDDED_VS_ONETOONE.md).
